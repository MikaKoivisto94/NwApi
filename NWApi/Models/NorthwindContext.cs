...
namespace NWApi.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<SalesByWeekDay> SalesByWeekDays { get; set; }
        public virtual DbSet<SalesTotalAllTime> SalesTotalAllTimes { get; set; }
        ...
        // Connection stringin alkuperäinen "huono" sijanti
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SalesByWeekDay>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("SalesByWeekDay");
            ...
            modelBuilder.Entity<SalesTotalAllTime>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Sales Total All Time");
